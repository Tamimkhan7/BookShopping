...
namespace BookShopping.Services
{
    public class StockRepository : IStockRepository
    {
        ...
        public async Task ManageStock(StockDTO stockToManage)
        {
            ...
            //if there is already a stock for given book id, update stocks quantity
            ...
            if (existingStock is null)
            {
                var stock = new Stock
                {
                    //tahole new kore stock ar table a bookid and quantity add korbo
        ...
        {
            //into book_stock ,, this is for left join
